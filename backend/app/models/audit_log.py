...
class EmployerSearch(Base):
    ...
    employer_user_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False)
    ...
    result_profile_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True))
